...
source: "https://www.comflowy.com/zh-CN/basics/stable-diffusion-foundation"
author:
...
1. 在教程中，你会看到高亮的内容，比如 ==Latent Space（潜空间）== 。这意味它可能会在后续的教程中再次提到，亦或者会在 ComfyUI 里出现，你需要重点关注。
...
![](https://www.comflowy.com/stable-diffusion-foundation/004.png)
...
你可能好奇为何是「降噪」而不是其他方式？你可以查看 [Stable Diffusion 进阶](https://www.comflowy.com/zh-CN/advanced/stable-diffusion-advanced) 。
...
目前 Stable Diffusion 常用的 Text Encoder 用的是 [OpenAI 开源](https://openai.com/research/clip) 的 ==CLIP== 模型，全称为 Contrastive Language Image Pre-training（对比语言图像预训练）。我们照例先画个图：
